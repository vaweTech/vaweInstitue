  ...
  return (
    <main className="flex flex-col items-center mb-[-64px] justify-center lg:mt-[-450px] md:mt-[-350px] mt-[-250px] px-4 py-12 sm:px-8 sm:py-16 bg-[#edfcfc]">
      ...
      <div className="w-full max-w-[650px] flex flex-col justify-center text-center mb-12">
        <h2 className="text-xl sm:text-2xl lg:text-3xl 2xl:text-5xl font-bold leading-tight mb-4 text-gray-800">
          Why Choose Our Courses
        </h2>
        <p className="text-xs sm:text-sm md:text-base 2xl:text-xl text-gray-700 mb-6 leading-relaxed">
      ...
      {/* STATS DIAMONDS */}
      <div className="w-full lg:w-[80%] mt-[-5px] grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-10 place-items-center">
