  ...
  return (
    ...
    >
      <nav className="w-full bg-[#221d55] px-4 sm:px-6 lg:px-12 xl:px-16">
        <div className="flex items-center justify-between h-87 ">
            ...
            <Link href="/" className="flex items-center space-x-1">
              ...
              >
                ...
                <Image
                  ...
                  width={100}
                  height={100}
                  className="object-cover w-full px-10 h-full"
                  priority
                  unoptimized
                />
              </div>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div ref={moreRef} className="relative" onMouseEnter={() => setIsMoreOpen(true)} onMouseLeave={() => setIsMoreOpen(false)}>
              <button className="flex items-center space-x-1 text-white hover:text-blue-600 transition-colors font-medium" aria-haspopup="menu" aria-expanded={isMoreOpen}>
                <span>More</span>
            ...
            <Link href="https://www.skillwins.in" target="_blank" rel="noopener noreferrer" className="px-4 py-2 border-2 bg-blue-600 text-white hover:bg-blue-700 border-blue-600  rounded-lg  transition-colors font-medium">
              LMS Login
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden pb-6 border-t border-gray-200 animate-fade-in">
            <div className="flex flex-col gap-3 px-4 pt-4">
              <button
                type="button"
                className="flex items-center justify-between gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
