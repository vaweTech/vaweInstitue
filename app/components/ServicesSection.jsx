...
const slideContent = [
  ...
  },
  {
    ...
    image: "/hero/lodinghero.png",
    description:
      "This item shows how to use a specific image per item. Useful when images vary in size.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {slideContent.map((item, index) => (
            <div
              key={index}
              className="bg-[#b8e1ff]/50 rounded-2xl border border-amber-200/40 p-4 shadow-sm hover:shadow-md transition"
            >
              ...
              <div className="space-y-1 text-left">
                ...
                <p className="text-xs md:text-sm text-indigo-600 italic">
                  {item.quotation}
                </p>
                ...
                <p className="text-xs md:text-sm text-slate-600 pt-1 leading-relaxed">
                  {item.description}
                </p>
              </div>
