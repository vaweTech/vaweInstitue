  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-100">
        {/* Page Header */}
        <section className="relative py-20 bg-gradient-to-br from-[#4facfe] to-[#00f2fe] text-white text-center">
        ...
        <section className="py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto px-6">
            {contactInfo.map((info, i) => (
              <div
                key={i}
                className="bg-white/80 backdrop-blur-lg border border-gray-100 shadow-xl rounded-3xl p-6 text-center hover:scale-105 transition-transform"
              >
                <div className={`mx-auto mb-4 w-16 h-16 rounded-full bg-gradient-to-br ${info.color} flex items-center justify-center text-white shadow-md`}>
                  {info.icon}
                </div>
        ...
        {/* Contact Form */}
        <section className="py-20 bg-white/60 backdrop-blur-lg">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <Card className="p-10 shadow-2xl rounded-3xl bg-white/80 backdrop-blur-md">
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <input
                      ...
                      className="p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400 outline-none"
                    />
                    <input
                      name="email"
                      type="email"
                  ...
                  <textarea
                    ...
                    className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-400 outline-none"
                  />
